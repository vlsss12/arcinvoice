...
async function copyTestReport(){if(!latestTestReport)return;try{await navigator.clipboard.writeText(latestTestReport);copyReportButton.textContent='Test report copied ✓';}catch(error){copyReportButton.textContent='Copy blocked by browser';}}
